...
const Testimonials = () => {
  return (
    <div className="h-[99vh] flex flex-col items-center justify-evenly">
      ...
      <div className="grid grid-cols-4 items-center place-items-center-safe w-full mb-13 px-15">
        {testimonials.map((item) =>
          <div className="max-w-[18rem] h-[15rem] p-8 bg-[#57C690] rounded hover:shadow-xl hover:shadow-black/10 brightness-95 hover:brightness-100 scale-95 flex flex-col items-center justify-between hover:scale-105 transition-all duration-300">
